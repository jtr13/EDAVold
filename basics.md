...
R Markdown is how you will be writing assignments for this course and Knitr is how you will generate an output file for submission. In general, they're a great way to communicate your findings to others.
...
* Don't know about Knitr? Here's [the specific section on Knitr](){target="_blank"} from the DataCamp course cited above. With this package, you can generate output documents from R Markdown files. 
