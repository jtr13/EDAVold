...
4. **Study R**: Start with DataCamp's free [Introduction to R](https://www.datacamp.com/courses/free-introduction-to-r) course. You can skip the sections on matrices and lists, which aren't important for this course. Next cover the material in the first section of [R for Data Science](http://r4ds.had.co.nz) It is based on the tidyverse, a group of packages which, among other things, make it easier to code in R:
